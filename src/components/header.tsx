        ...
        <div className="mx-auto px-6 md:px-12 flex items-center justify-between h-16">
            ...
            <a href="/" className="inline-block">
              <motion.img
                ...
                className={`h-12 transition-all duration-300 ${
                  logoColor === "white" ? "brightness-0 invert" : ""
                }`}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          >
            <motion.button
              ...
              className="p-2 bg-lorenzo-dark/80 border border-primar hover:bg-lorenzo-dark rounded-lg transition-colors text-primaria px-3 py-2.5"
              aria-label="Menu"
            >
